...
/**
 * Fragment responsible for displaying Tools category products.
 *
...
class ToolsFragment : BaseCategoryFragment() {
    ...
    // View model for managing Tools category data.
    val viewModel by viewModels<CategoryViewModel> {
        BaseCategoryViewModelFactory(firestore, Category.Tools)
    }
